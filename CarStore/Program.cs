...
using (var scope = app.Services.CreateScope())
{
    ...
    {
        db.HashSet("car:1", new HashEntry[]
        {
            new("Brand", "Toyota"),
            new("Model", "Camry"),
            new("Year", 2020),
        ...
        db.HashSet("car:2", new HashEntry[]
        {
            new("Brand", "BMW"),
            new("Model", "X5"),
            new("Year", 2019),
        ...
        db.HashSet("car:3", new HashEntry[]
        {
            new("Brand", "Audi"),
            new("Model", "A6"),
            new("Year", 2021),
        ...
        db.HashSet("car:4", new HashEntry[]
        {
            new("Brand", "Mercedes"),
            new("Model", "E-Class"),
            new("Year", 2018),
        ...
        db.HashSet("car:5", new HashEntry[]
        {
            new("Brand", "Kia"),
            new("Model", "K5"),
            new("Year", 2022),
